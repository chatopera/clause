...
const char* const DICT_PATH = "../../../../var/data/jieba/dict/jieba.dict.utf8";
const char* const HMM_PATH = "../../../../var/data/jieba/dict/hmm_model.utf8";
const char* const USER_DICT_PATH = "../../../../var/data/jieba/dict/user.dict.utf8";
const char* const IDF_PATH = "../../../../var/data/jieba/dict/idf.utf8";
const char* const STOP_WORD_PATH = "../../../../var/data/jieba/dict/stop_words.utf8";
