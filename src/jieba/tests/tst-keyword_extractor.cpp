...
TEST(JiebaTest, KeywordExtractorTest1) {
  KeywordExtractor Extractor("../../../../var/test/jieba/testdata/extra_dict/jieba.dict.small.utf8",
                             HMM_PATH,
                             IDF_PATH,
                             STOP_WORD_PATH);
...
TEST(JiebaTest, KeywordExtractorTest2) {
  KeywordExtractor Extractor("../../../../var/test/jieba/testdata/extra_dict/jieba.dict.small.utf8",
                             HMM_PATH,
                             IDF_PATH,
                             STOP_WORD_PATH,
