...
if(NOT JSONCPP_FOUND)
	...
	set(_JSONCPP_INCLUDE_HINTS ${CMAKE_CURRENT_SOURCE_DIR}/include)
    set(_JSONCPP_LIB_HINTS ${CMAKE_CURRENT_SOURCE_DIR}/lib/x86_64-linux-gnu)
	if(PKG_CONFIG_FOUND)
    ...
    MESSAGE(STATUS "_JSONCPP_INCLUDE_HINTS -->" ${_JSONCPP_INCLUDE_HINTS})
    MESSAGE(STATUS "_JSONCPP_LIB_HINTS -->" ${_JSONCPP_LIB_HINTS})
	...
	if(JSONCPP_FOUND)
        ...
        GET_FILENAME_COMPONENT(JSONCPP_LIBRARY_DIRNAME ${JSONCPP_LIBRARY} DIRECTORY)
        set(JSONCPP_LIBRARY_SHARED "${JSONCPP_LIBRARY_DIRNAME}/libjsoncpp.so")
        set(JSONCPP_LIBRARY_STATIC "${JSONCPP_LIBRARY_DIRNAME}/libjsoncpp.a")
        set(JSONCPP_LIBRARY_IS_SHARED "YES")
...
MESSAGE(STATUS "JSONCPP_LIBRARY_STATIC --> " ${JSONCPP_LIBRARY_STATIC})
MESSAGE(STATUS "JSONCPP_LIBRARY_SHARED --> " ${JSONCPP_LIBRARY_SHARED})
MESSAGE(STATUS "JSONCPP_LIBRARY_IS_SHARED --> " ${JSONCPP_LIBRARY_IS_SHARED})
